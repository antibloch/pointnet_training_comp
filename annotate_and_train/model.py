...
class PointNetBackbone(nn.Module):
    ...
    ''' 
    def __init__(self, feat_dim=3,num_points=2500, num_global_feats=1024, local_feat=True):
        ''' Initializers:
        ...
        self.tnet1 = Tnet(dim=feat_dim, num_points=num_points)
        self.tnet2 = Tnet(dim=64, num_points=num_points)

        # shared MLP 1
        self.conv1 = nn.Conv1d(feat_dim, 64, kernel_size=1)
...
class PointNetSegHead(nn.Module):
    ''' Segmentation Head '''
    def __init__(self, feat_dim =6, num_points=2500, num_global_feats=1024, m=2):
        ...
        # get the backbone 
        self.backbone = PointNetBackbone(feat_dim, num_points, num_global_feats, local_feat=True)
